  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="planDetailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['travel:planDetail:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['travel:planDetail:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="planDetailRef" :model="form" :rules="rules" label-width="80px">
                        ...
                        <el-form-item label="项目数量" prop="projectQuantity">
                          <el-input v-model="form.projectQuantity" placeholder="请输入项目数量" />
                        </el-form-item>
                        <el-form-item label="项目单位" prop="projectUnit">
                          <el-input v-model="form.projectUnit" placeholder="请输入项目单位" />
                        </el-form-item>
                        <el-form-item label="金额" prop="planAmount">
                          <el-input v-model="form.planAmount" placeholder="请输入金额" />
                        </el-form-item>
                        <el-form-item label="现金" prop="planCash">
...
<script setup name="PlanDetail">
  import { listPlanDetail, getPlanDetail, delPlanDetail, addPlanDetail, updatePlanDetail } from "@/api/travel/planDetail";
