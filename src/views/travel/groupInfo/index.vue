    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['travel:groupInfo:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['travel:groupInfo:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['travel:groupInfo:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['travel:groupInfo:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listGroupInfo, getGroupInfo, delGroupInfo, addGroupInfo, updateGroupInfo } from "@/api/travel/groupInfo";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除组团社信息编号为"' + groupIds + '"的数据项？').then(function() {
        return delGroupInfo(groupIds);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('travel/groupInfo/export', {
        ...this.queryParams
      }, `groupInfo_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
